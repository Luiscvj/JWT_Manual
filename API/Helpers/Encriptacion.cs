...
namespace  API.Helpers;
    ...
    string IEncriptacion.AES256_LOGIN_Key
    {
        get
        {
            return  "eXSQ6pSMaax9fA8dJLURCWn79jMPskCj";
        }
    }

    string IEncriptacion.AES256_USER_Key
    {
        get
        {
            return "hUf3eof71VCa7IIjFlNewZ73yBWjckdX";
        }
    }
